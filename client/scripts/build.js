...
const exclude = ['node_modules/**', '*.spec.js*'];

// Don't bundle regular dependencies + [list contents]
// Instead, include them externally
const externalAll = Object.keys(pkg.dependencies).concat([
  'child_process',
]);
...
const pluginsWithCoverage = pluginsAll.concat([istanbul({ exclude })]);
...
// Unit Tests
generateSpecFile();
compile('specs.js.autogenerated', externalDev, pluginsWithCoverage);
